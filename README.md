...
A `schedule` for Friday 5pm to Sunday 8am, early enough in the weekend
to leave time to fix anything that breaks. The base config uses it for the
weekly patch/pin/digest group. Extend it at the top level or inside a
`packageRules` entry:
